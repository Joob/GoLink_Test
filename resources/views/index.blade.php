...
<head>
    ...
    <title>
        {{ $config->app->title ?? 'GoLink.co - Decentralized Storage ' }} # {{ $config->app->description ?? __t('app_description') }}
    </title>
    ...
    <meta name="apple-mobile-web-app-title" content="{{ $config->app->name ?? 'GoLink.co - Decentralized Storage' }}">
    ...
    <script data-host="https://analytics.golink.co" data-dnt="false" src="https://analytics.golink.co/js/script.js" id="ZwSg9rf6GA" async defer></script>

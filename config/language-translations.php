...
return [
    ...
    'regular'  => [
		...
		'page_contact_us.name'							 => 'Name',
        'page_contact_us.form.name'                      => 'Type your name',
        ...
        'page_shared.password_sharing_tip'               => 'Password Sharing Tip',
        'page_shared.password_sharing_tip_desc'          => 'Password Sharing Tip on Link Shared',
        'page_shared.password_tip_words'                 => 'Max 40 Words',
        'page_shared.password_tip_is'                    => 'The Password Sharing is',
        'submit'                                         => 'Submit',
        ...
        'page_sign_in.resend_otp_code_text'              => 'OTP - If you have not received it - request new code!',
        'page_sign_in.resend_otp_code_button'            => 'OTP - Send New Code',
        'page_sign_in.button_otp_code'                   => 'OTP - Log In',
        'page_sign_in.placeholder_otp'                   => 'OTP - security code',
        'page_sign_in.subtitle_otp'                      => 'OTP - Please type your security code',
        'validation_errors.invalid_otp_code'             => 'OTP - Invalid Security Code',
        'validation_errors.expired_otp_code'             => 'OTP - Security Code has expired! Refresh the page and try again!',
        ...
        'shared.empty_shared_desc'                       => "you haven't shared any files yet",
        ...
        'toaster.please_wait'                            => 'Please Wait',
        'toaster.folder_created'                         => 'Folder Created',
        'toaster.creating_zip'                           => 'Creating ZIP Files and Downloading ...',
        'toaster.file_moved'                             => 'File Moved',
        'toaster.folder_file_renamed'                    => 'Folder/File Renamed',
        'toaster.item_restored'                          => 'Item Restored',
        'toaster.files_deleted'                          => 'File(s) Deleted',
        'toaster.permanently_removing_files'             => 'Permanently Removing Files',
        'toaster.permanently_removed_files'              => 'Permanently Removed Files',
        'toaster.successfully_cleared'                   => 'Your trash was successfully cleared.',
        'file'                                           => 'File',
        'folder'                                         => 'Folder',
        ...
        'user_settings.state_desc'                       => 'state, county, province or region',
        ...
        'app_description'                                => 'Descentralized | Encrypted | Privacy Cloud Storage, Share &amp; Get Files Instantly',
        'user_not_fount'                                 => 'We can\'t find a user with that e-mail address.',
        'incorrect_password'                             => 'Sorry, your password is incorrect.',
        'time'                                           => 'd. M. Y, h:i',
        'home'                                           => 'Home',
        'shared_link_email_greeting'                     => 'Shared Files',
        'shared_link_email_subject'                      => '🙋 :user share some files with you.',
        ...
        'hello'                                          => 'Hello!',
        'reset_password_greeting'                        => 'Reset Password',
        'reset_password_subject'                         => ' # Reset password for your account',
        ...
        'verify_email_greeting'                          => 'Verify Email Address',
        ...
        'verify_email_link'                              => 'Verify your Email',
        'languages'                                      => 'Languages',
        ...
        'your_trash_is_empty_desc'                       => 'permanently deleted all files from trash',
        'create'                                         => 'Create',
        ...
        'team_invitation_notify_greeting'                => 'Invited Team Folder',
        ...
        'file_request_filled_mail_greeting'              => "File Request",
        ...
        'file_request_notify_greeting'                   => 'Upload Request',
        ...
        'index.header_title'                             => 'Header Title',
        'index.header_description'                       => 'Header Description',
        'index.features_title'                           => 'Feature Title',
        'index.features_description'                     => 'Feature Description',
        'index.feature_title_1'                          => 'Feature Title 1',
        'index.feature_description_1'                    => 'Feature Description 1',
        'index.feature_title_2'                          => 'Feature Title 2',
        'index.feature_description_2'                    => 'Feature Description 2',
        'index.feature_title_3'                          => 'Feature Title 3',
        'index.feature_description_3'                    => 'Feature Description 3',
        'index.pricing_title'                            => 'Pricing Title',
        'index.pricing_description'                      => 'Pricing Description',
        ...
        'download_is_starting'                           => 'The download is starting',
        'calculate_download_percentage'                  => 'Calculate the time for download...',
        'file_0kb_upload'                                => 'File: - {item.file.name} - with "0kb" can\'t be uploaded',
        'access_login'                                   => 'Access Login',
        'clean_all_sessions'                             => 'Clean all Sessions from your Account.',
        'logout_all_sessions'                            => 'Logout All Sessions',
        'delete_all_sessions'                            => 'Remove All Logged in Sessions',
        'enter_password_delete_all_sessions'             => 'Please enter your password to remove all logged in sessions',
        'started_title_left'                             => 'Millions of people trust us',
        'started_title_left_text_1'                      => 'Join the millions of other individuals and businesses who trust us to store and protect their data in the cloud',
        'started_upload_info_right'                      => 'Uploaded Files',
        'started_register_info_right'                    => 'Registered Users',
        'ask_when_delete_title'                          => 'Delete the Item ?',
        'ask_when_delete_desc'                           => 'The Item will be sent to the trash, you will still be able to recover what you deleted.\n When you delete from the "trash" folder it will be permanently deleted.',
        'ask_when_permanent_delete_title'                => 'Permanently Delete All Items ?',
        'ask_when_permanent_delete_desc'                 => 'Be careful, if you delete permanently, it will no longer be possible to recover the file(s).',
    ],
];

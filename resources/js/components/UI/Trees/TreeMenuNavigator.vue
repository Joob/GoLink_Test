<template>
    <div>
        ...
        >
            ...
            <b
                class="button-icon inline-block cursor-pointer rounded-lg sm:p-2 hover:bg-light-300 dark:hover:bg-4x-dark-foreground overflow-hidden text-ellipsis text-xs font-bold"

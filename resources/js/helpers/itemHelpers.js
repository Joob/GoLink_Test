...
const itemHelpers = {
    install(Vue) {
        Vue.prototype.$emptyTrash = function (id) {
            //store.dispatch('emptyTrash')

            events.$emit('confirm:open', {
                title: i18n.t('ask_when_permanent_delete_title'),
                message: i18n.t(
                    'ask_when_permanent_delete_desc'
                ),
                action: {
                    item: id,
                    operation: 'remove-permanent-folders-files',
                },
            })
        }
        ...
        Vue.prototype.$deleteFileOrFolder = function (entry, id) {
            events.$emit('confirm:open', {
                title: i18n.t('ask_when_delete_title'),
                message: i18n.t(
                    'ask_when_delete_desc'
                ),
                action: {
                    id: id,
                    operation: 'remove-folders-files',
                },
            })
        }
